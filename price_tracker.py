"""
Build a Bear Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Build a Bear.

Docs  : https://docs.brightdata.de/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.de/products/insights/price-tracker/build-a-bear
"""
...
# Set your Web Scraper ID after building your Build a Bear scraper:
# https://brightdata.de/products/web-scraper/build-a-bear
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Build a Bear scraper at: https://brightdata.de/products/web-scraper/build-a-bear\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Build a Bear product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Build a Bear products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Build a Bear category page.

    Example:
        results = discover_by_category("https://buildabear.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.buildabear.com/product/sample-item-123456",
        # Add more Build a Bear product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "build-a-bear_prices.json"
    ...
    # cat_results = discover_by_category("https://buildabear.com/category/sample", limit=50)
